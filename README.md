...
<img width="341" height="548" alt="image" src="https://github.com/user-attachments/assets/034f1e95-f4d2-4020-b717-ce894de6884e" />
  ...
  1. サイドペイン上（移動先）で移動先フォルダを選択、またはショートカットキーを設定
  2. サイドペイン中（移動元）で閲覧したいフォルダを選択（または右側にファイルをドロップ、または、サイドペイン下（Files）でアイテムをクリック）
  3. メディアを確認しながら、スペースキーまたはAlt+1〜9で振り分け（チェック済みファイルがあれば一括移動）
  4. 自動的に次のファイルが表示される
